      ...
      {fruitPositions.map((fruit, index) => {
        ...
        return (
          ...
          >
            ...
            <div
              className="relative w-4 h-4 md:w-10 md:h-10 flex items-center justify-center"
              style={{
                filter: isHovered 
            ...
            {/* Label on hover */}
            <span
              className={`absolute left-1/2 -translate-x-1/2 whitespace-nowrap px-2 py-0.5 md:px-3 md:py-1.5 rounded-full text-[9px] md:text-sm font-medium transition-all duration-300 ${
                isHovered ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'
              }`}
              style={{
                top: '100%',
                marginTop: isMobile ? '1px' : '6px',
